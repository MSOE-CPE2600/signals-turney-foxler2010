...
all: $(SIG_HANDLER_EXECUTABLE) $(SIG_ALARM_EXECUTABLE) $(SIG_SEGFAULT_EXECUTABLE)

debug: CFLAGS += -g
debug: $(SIG_HANDLER_EXECUTABLE) $(SIG_ALARM_EXECUTABLE) $(SIG_SEGFAULT_EXECUTABLE)

clean:
	rm -rf $(SIG_HANDLER_OBJECTS) $(SIG_ALARM_OBJECTS) $(SIG_SEGFAULT_OBJECTS)
	rm -rf $(SIG_HANDLER_EXECUTABLE) $(SIG_ALARM_EXECUTABLE) $(SIG_SEGFAULT_EXECUTABLE)
	rm -rf *.d
